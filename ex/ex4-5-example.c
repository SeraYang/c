...
{
   sp = 0;  /* the data in the array no need to be clear
               just notify that the spaces are available */
}

/* deal with a string/name this may be either a maths 
 * function or for future exercises: a variable */
void dealWithName(char s[])
{
   double op2;
